...
for l = 1:20 % Number of iterations to average for error bars
    ...
    R1_BB_SNR250 = awgn(R1_BB,250,'measured');
    R2_BB_SNR250 = awgn(R2_BB,250,'measured');
    change_I_BB_SNR250 = log(R2_BB_SNR250) - log(R1_BB_SNR250);
    % change_I_BB_SNR250 = log(R2_BB_SNR250) - log(R1_BB);
...
%     R1_BB_SNR250 = awgn(R1_BB,250,'measured');
%     R2_BB_SNR250 = awgn(R2_BB,250,'measured');
%     change_I_BB_SNR250 = log(R2_BB_SNR250) - log(R1_BB_SNR60);
%     % change_I_BB_SNR60 = log(R2_BB_SNR60) - log(R1_BB);
    ...
    conc_BB_SNR250 =  E_prime_invert_BB * (-change_I_BB_SNR250 ./ (SD*ave_DPF_BB))';
    ...
    for t = 1:length(ac_conc_change)
        ...
        perc_diff_BB_SNR250(t) = ((conc_BB_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_diff_BB_SNR60(t) = ((conc_BB_SNR60(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
    end

    perc_vector_SNR = [20;30;40;50;60;100];
    perc_diff_SNR_vector = [perc_diff_BB_SNR20;perc_diff_BB_SNR30;perc_diff_BB_SNR40;perc_diff_BB_SNR250;perc_diff_BB_SNR60;perc_diff_BB];
...
% %% Repeat with previously assumed DPF values instead
    ...
    conc_assDPF_Eadd5_SNR250 = pinv(BB_E_add5) * (-change_I_BB_SNR250 ./ (SD*DPF_assumed))';

    conc_assDPF_Eadd10_SNR250 = pinv(BB_E_add10) * (-change_I_BB_SNR250 ./ (SD*DPF_assumed))';

    conc_assDPF_Eadd15_SNR250 = pinv(BB_E_add15) * (-change_I_BB_SNR250 ./ (SD*DPF_assumed))';

    conc_assDPF_Eadd15_SNR30 = pinv(BB_E_add15) * (-change_I_BB_SNR30 ./ (SD*DPF_assumed))';

    %
    conc_DPFadd5_Eadd5_SNR250 = pinv(BB_E_add5) * (-change_I_BB_SNR250 ./ (SD*BB_DPF_add5))';

    conc_DPFadd10_Eadd5_SNR250 = pinv(BB_E_add5) * (-change_I_BB_SNR250 ./ (SD*BB_DPF_add10))';

    conc_DPFadd15_Eadd5_SNR250 = pinv(BB_E_add5) * (-change_I_BB_SNR250 ./ (SD*BB_DPF_add15))';

    %
    conc_DPFadd10_Eadd10_SNR250 = pinv(BB_E_add10) * (-change_I_BB_SNR250 ./ (SD*BB_DPF_add10))';

    conc_DPFadd15_Eadd15_SNR250 = pinv(BB_E_add15) * (-change_I_BB_SNR250 ./ (SD*BB_DPF_add15))';

    %
    %------------------------------------------------------------
    conc_assDPF_Etake10 = pinv(BB_E_take10) * (-change_I_BB ./ (SD*DPF_assumed))';

    conc_assDPF_Etake5_SNR250 = pinv(BB_E_take5) * (-change_I_BB_SNR250 ./ (SD*DPF_assumed))';

    conc_assDPF_Etake10_SNR250 = pinv(BB_E_take10) * (-change_I_BB_SNR250 ./ (SD*DPF_assumed))';

    conc_assDPF_Etake15_SNR250 = pinv(BB_E_take15) * (-change_I_BB_SNR250 ./ (SD*DPF_assumed))';

    conc_assDPF_Etake15_SNR30 = pinv(BB_E_take15) * (-change_I_BB_SNR30 ./ (SD*DPF_assumed))';

    %
    conc_DPFtake5_Etake5_SNR250 = pinv(BB_E_take5) * (-change_I_BB_SNR250 ./ (SD*BB_DPF_take5))';

    conc_DPFtake10_Etake5_SNR250 = pinv(BB_E_take5) * (-change_I_BB_SNR250 ./ (SD*BB_DPF_take10))';

    conc_DPFtake15_Etake5_SNR250 = pinv(BB_E_take5) * (-change_I_BB_SNR250 ./ (SD*BB_DPF_take15))';

    %
    conc_DPFtake10_Etake10_SNR250 = pinv(BB_E_take10) * (-change_I_BB_SNR250 ./ (SD*BB_DPF_take10))';

    conc_DPFtake15_Etake15_SNR250 = pinv(BB_E_take15) * (-change_I_BB_SNR250 ./ (SD*BB_DPF_take15))';

    %
    %--------------------------------------------------------------------
    %
    conc_DPFadd5_Etake5_SNR250 = pinv(BB_E_take5) * (-change_I_BB_SNR250 ./ (SD*BB_DPF_add5))';

    conc_DPFadd10_Etake5_SNR250 = pinv(BB_E_take5) * (-change_I_BB_SNR250 ./ (SD*BB_DPF_add10))';

    conc_DPFadd15_Etake5_SNR250 = pinv(BB_E_take5) * (-change_I_BB_SNR250 ./ (SD*BB_DPF_add15))';

    %
    conc_DPFadd10_Etake10_SNR250 = pinv(BB_E_take10) * (-change_I_BB_SNR250 ./ (SD*BB_DPF_add10))';

    conc_DPFadd15_Etake15_SNR250 = pinv(BB_E_take15) * (-change_I_BB_SNR250 ./ (SD*BB_DPF_add15))';

    %-------------------------------------------------------------
    %
    conc_DPFtake5_Eadd5_SNR250 = pinv(BB_E_add5) * (-change_I_BB_SNR250 ./ (SD*BB_DPF_take5))';

    conc_DPFtake10_Eadd5_SNR250 = pinv(BB_E_add5) * (-change_I_BB_SNR250 ./ (SD*BB_DPF_take10))';

    conc_DPFtake15_Eadd5_SNR250 = pinv(BB_E_add5) * (-change_I_BB_SNR250 ./ (SD*BB_DPF_take15))';

    %
    conc_DPFtake10_Eadd10_SNR250 = pinv(BB_E_add10) * (-change_I_BB_SNR250 ./ (SD*BB_DPF_take10))';

    conc_DPFtake15_Eadd15_SNR250 = pinv(BB_E_add15) * (-change_I_BB_SNR250 ./ (SD*BB_DPF_take15))';

    conc_DPFtake15_Eadd10_SNR250 = pinv(BB_E_add10) * (-change_I_BB_SNR250 ./ (SD*BB_DPF_take15))';

    conc_DPFtake10_Eadd15_SNR250 = pinv(BB_E_add15) * (-change_I_BB_SNR250 ./ (SD*BB_DPF_take10))';

    conc_DPFadd5_Etake15_SNR250 = pinv(BB_E_take15) * (-change_I_BB_SNR250 ./ (SD*BB_DPF_add5))';

    conc_DPFadd5_Etake10_SNR250 = pinv(BB_E_take10) * (-change_I_BB_SNR250 ./ (SD*BB_DPF_add5))';

    conc_DPFtake5_Eadd15_SNR250 = pinv(BB_E_add15) * (-change_I_BB_SNR250 ./ (SD*BB_DPF_take5))';

    conc_DPFtake5_Eadd10_SNR250 = pinv(BB_E_add10) * (-change_I_BB_SNR250 ./ (SD*BB_DPF_take5))';

    conc_DPFadd10_Etake15_SNR250 = pinv(BB_E_take15) * (-change_I_BB_SNR250 ./ (SD*BB_DPF_add10))';

    conc_DPFadd15_Etake10_SNR250 = pinv(BB_E_take10) * (-change_I_BB_SNR250 ./ (SD*BB_DPF_add15))';

    for t = 1:length(ac_conc_change)
        perc_error_BB_DPFtake15_Eadd15_SNR250(t) = ((conc_DPFtake15_Eadd15_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB_DPFtake10_Eadd10_SNR250(t) = ((conc_DPFtake10_Eadd10_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB_DPFtake5_Eadd5_SNR250(t) = ((conc_DPFtake5_Eadd5_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB_DPFadd15_Etake15_SNR250(t) = ((conc_DPFadd15_Etake15_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB_DPFadd10_Etake10_SNR250(t) = ((conc_DPFadd10_Etake10_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB_DPFadd5_Etake5_SNR250(t) = ((conc_DPFadd5_Etake5_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB_DPFadd15_Eadd15_SNR250(t) = ((conc_DPFadd15_Eadd15_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB_DPFadd10_Eadd10_SNR250(t) = ((conc_DPFadd10_Eadd10_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB_DPFadd5_Eadd5_SNR250(t) = ((conc_DPFadd5_Eadd5_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB_DPFtake15_Etake15_SNR250(t) = ((conc_DPFtake15_Etake15_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB_DPFtake10_Etake10_SNR250(t) = ((conc_DPFtake10_Etake10_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB_DPFtake5_Etake5_SNR250(t) = ((conc_DPFtake5_Etake5_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB_DPFtake15_Eadd10_SNR250(t) = ((conc_DPFtake15_Eadd10_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB_DPFtake15_Eadd5_SNR250(t) = ((conc_DPFtake15_Eadd5_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB_DPFtake10_Eadd15_SNR250(t) = ((conc_DPFtake10_Eadd15_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB_DPFtake10_Eadd5_SNR250(t) = ((conc_DPFtake10_Eadd5_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB_DPFadd5_Etake15_SNR250(t) = ((conc_DPFadd5_Etake15_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB_DPFadd5_Etake10_SNR250(t) = ((conc_DPFadd5_Etake10_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB_DPFtake5_Eadd15_SNR250(t) = ((conc_DPFtake5_Eadd15_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB_DPFtake5_Eadd10_SNR250(t) = ((conc_DPFtake5_Eadd10_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB_DPFadd10_Etake15_SNR250(t) = ((conc_DPFadd10_Etake15_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB_DPFadd10_Etake5_SNR250(t) = ((conc_DPFadd10_Etake5_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB_DPFadd15_Etake10_SNR250(t) = ((conc_DPFadd15_Etake10_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB_DPFadd15_Etake5_SNR250(t) = ((conc_DPFadd15_Etake5_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB_5s_SNR250(t) = max(abs([perc_error_BB_DPFtake5_Etake5_SNR250(t), perc_error_BB_DPFadd5_Eadd5_SNR250(t), perc_error_BB_DPFadd5_Etake5_SNR250(t), perc_error_BB_DPFtake5_Eadd5_SNR250(t)]));
        perc_error_BB_10s_SNR250(t) = max(abs([perc_error_BB_DPFtake10_Etake10_SNR250(t), perc_error_BB_DPFadd10_Eadd10_SNR250(t), perc_error_BB_DPFadd10_Etake10_SNR250(t), perc_error_BB_DPFtake10_Eadd10_SNR250(t)]));
        perc_error_BB_15s_SNR250(t) = max(abs([perc_error_BB_DPFtake15_Etake15_SNR250(t), perc_error_BB_DPFadd15_Eadd15_SNR250(t), perc_error_BB_DPFadd15_Etake15_SNR250(t), perc_error_BB_DPFtake15_Eadd15_SNR250(t)]));
    end
    %%
    perc_accum_errors_DPFE_BBSNR250 = [perc_diff_BB; perc_error_BB_5s_SNR250; perc_error_BB_10s_SNR250; perc_error_BB_15s_SNR250];

    perc_accum_errors_DPFE_BBSNR250_saved{l} = perc_accum_errors_DPFE_BBSNR250(:,:); %Save each iteration to cell array
    ...
    % plot(percent_vector,perc_accum_errors_DPFE_BBSNR250(:,1),'r*-','MarkerSize',20)
    % hold on
    % plot(percent_vector,perc_accum_errors_DPFE_BBSNR250(:,2),'bs-','MarkerSize',10)
    % plot(percent_vector,perc_accum_errors_DPFE_BBSNR250(:,5),'go-','MarkerSize',10)
    % ax = gca;
    % ax.FontSize = 20;
    % %ylim([0 35]);
    % legend('HbO','HbR','oxCCO','Location','Best');
    % xlabel('Percentage change in both extinction coefficient and DPF values');
    % ylabel('Percentage error in chromophore concentration values');
    % title({'Comparison of percentage errors for increasing extinction coefficient', 'and DPF percentage changes for broadband system 1 (680-921nm), SNR = 250'});
...
for u = 1:4
    for j = 1:3
        for k = 1:10
            vector_error_BBSNR250(k,j) = perc_accum_errors_DPFE_BBSNR250_saved{1,k}(u,j);
        end
        ave_vector_error_BBSNR250(u,j) = mean(vector_error_BBSNR250(:,j));
        high_bar_vector_error_BBSNR250(u,j) = max(vector_error_BBSNR250(:,j));
        low_bar_vector_error_BBSNR250(u,j) = min(vector_error_BBSNR250(:,j));
    end
end
...
FigH = figure('Position', get(0, 'Screensize'));
F = getframe(FigH);
imwrite(F.cdata, 'Comparison of percentage errors for increasing extinction coefficient and DPF percentage changes for broadband system 1 SNR 250.png', 'png')
errorbar(percent_vector,ave_vector_error_BBSNR250(:,1),low_bar_vector_error_BBSNR250(:,1),high_bar_vector_error_BBSNR250(:,1),'r*-','MarkerSize',20,'LineWidth',1.8)
hold on
errorbar(percent_vector,ave_vector_error_BBSNR250(:,2),low_bar_vector_error_BBSNR250(:,2),high_bar_vector_error_BBSNR250(:,2),'bs-','MarkerSize',20,'LineWidth',1.5)
errorbar(percent_vector,ave_vector_error_BBSNR250(:,3),low_bar_vector_error_BBSNR250(:,3),high_bar_vector_error_BBSNR250(:,3),'go-','MarkerSize',20,'LineWidth',1)
grid on
ax = gca;
ax.FontSize = 20;
xlim([-5 20]);
...
ylabel('Percentage error in chromophore concentration values');
title({'Comparison of percentage errors for increasing extinction coefficient', 'and DPF percentage changes for broadband system 1 (680-921nm), SNR = 250'});
saveas(gcf,'Comparison of percentage errors for increasing extinction coefficient percentage changes for broadband system 1 SNR 250.png')
...
for l = 1:20 % Number of iterations to average for error bars
    ...
    R1_BB2_SNR250 = awgn(R1_BB2,50,'measured');
    R2_BB2_SNR250 = awgn(R2_BB2,50,'measured');
    change_I_BB2_SNR250 = log(R2_BB2_SNR250) - log(R1_BB2_SNR250);
    % change_I_BB2_SNR250 = log(R2_BB2_SNR250) - log(R1_BB2);
    ...
    conc_BB2_SNR250 =  E_prime_invert_BB2 * (-change_I_BB2_SNR250 ./ (SD*ave_DPF_BB2))';
    ...
    for t = 1:length(ac_conc_change)
        ...
        perc_diff_BB2_SNR250(t) = ((conc_BB2_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_diff_BB2_SNR60(t) = ((conc_BB2_SNR60(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
    end

    perc_vector_SNR = [20;30;40;50;60;100];
    perc_diff_SNR_vector_BB2 = [perc_diff_BB2_SNR20;perc_diff_BB2_SNR30;perc_diff_BB2_SNR40;perc_diff_BB2_SNR250;perc_diff_BB2_SNR60;perc_diff_BB2];
...
%     saveas(gcf,'Comparison of percentage errors for increasing extinction coefficient percentage changes for broadband system 2.png')
    ...
    % 
    % conc_BB2_assDPF_Eadd5_SNR250 = pinv(BB2_E_add5) * (-change_I_BB2_SNR250 ./ (SD*DPF_assumed))';
    % 
    % conc_BB2_assDPF_Eadd10_SNR250 = pinv(BB2_E_add10) * (-change_I_BB2_SNR250 ./ (SD*DPF_assumed))';
    % 
    % conc_BB2_assDPF_Eadd15_SNR250 = pinv(BB2_E_add15) * (-change_I_BB2_SNR250 ./ (SD*DPF_assumed))';
    % 
    % conc_BB2_assDPF_Eadd15_SNR30 = pinv(BB2_E_add15) * (-change_I_BB2_SNR30 ./ (SD*DPF_assumed))';

    %
    conc_BB2_DPFadd5_Eadd5_SNR250 = pinv(BB2_E_add5) * (-change_I_BB2_SNR250 ./ (SD*BB2_DPF_add5))';

    conc_BB2_DPFadd10_Eadd5_SNR250 = pinv(BB2_E_add5) * (-change_I_BB2_SNR250 ./ (SD*BB2_DPF_add10))';

    conc_BB2_DPFadd15_Eadd5_SNR250 = pinv(BB2_E_add5) * (-change_I_BB2_SNR250 ./ (SD*BB2_DPF_add15))';

    %
    conc_BB2_DPFadd10_Eadd10_SNR250 = pinv(BB2_E_add10) * (-change_I_BB2_SNR250 ./ (SD*BB2_DPF_add10))';

    conc_BB2_DPFadd15_Eadd15_SNR250 = pinv(BB2_E_add15) * (-change_I_BB2_SNR250 ./ (SD*BB2_DPF_add15))';

    %
    %------------------------------------------------------------
    % conc_BB2_assDPF_Etake10 = pinv(BB2_E_take10) * (-change_I_BB2 ./ (SD*DPF_assumed))';
    % 
    % conc_BB2_assDPF_Etake5_SNR250 = pinv(BB2_E_take5) * (-change_I_BB2_SNR250 ./ (SD*DPF_assumed))';
    % 
    % conc_BB2_assDPF_Etake10_SNR250 = pinv(BB2_E_take10) * (-change_I_BB2_SNR250 ./ (SD*DPF_assumed))';
    % 
    % conc_BB2_assDPF_Etake15_SNR250 = pinv(BB2_E_take15) * (-change_I_BB2_SNR250 ./ (SD*DPF_assumed))';
    % 
    % conc_BB2_assDPF_Etake15_SNR30 = pinv(BB2_E_take15) * (-change_I_BB2_SNR30 ./ (SD*DPF_assumed))';
    % 
    % %
    conc_BB2_DPFtake5_Etake5_SNR250 = pinv(BB2_E_take5) * (-change_I_BB2_SNR250 ./ (SD*BB2_DPF_take5))';

    conc_BB2_DPFtake10_Etake5_SNR250 = pinv(BB2_E_take5) * (-change_I_BB2_SNR250 ./ (SD*BB2_DPF_take10))';

    conc_BB2_DPFtake15_Etake5_SNR250 = pinv(BB2_E_take5) * (-change_I_BB2_SNR250 ./ (SD*BB2_DPF_take15))';

    %
    conc_BB2_DPFtake10_Etake10_SNR250 = pinv(BB2_E_take10) * (-change_I_BB2_SNR250 ./ (SD*BB2_DPF_take10))';

    conc_BB2_DPFtake15_Etake15_SNR250 = pinv(BB2_E_take15) * (-change_I_BB2_SNR250 ./ (SD*BB2_DPF_take15))';

    %
    %--------------------------------------------------------------------
    %
    conc_BB2_DPFadd5_Etake5_SNR250 = pinv(BB2_E_take5) * (-change_I_BB2_SNR250 ./ (SD*BB2_DPF_add5))';

    conc_BB2_DPFadd10_Etake5_SNR250 = pinv(BB2_E_take5) * (-change_I_BB2_SNR250 ./ (SD*BB2_DPF_add10))';

    conc_BB2_DPFadd15_Etake5_SNR250 = pinv(BB2_E_take5) * (-change_I_BB2_SNR250 ./ (SD*BB2_DPF_add15))';

    %
    conc_BB2_DPFadd10_Etake10_SNR250 = pinv(BB2_E_take10) * (-change_I_BB2_SNR250 ./ (SD*BB2_DPF_add10))';

    conc_BB2_DPFadd15_Etake15_SNR250 = pinv(BB2_E_take15) * (-change_I_BB2_SNR250 ./ (SD*BB2_DPF_add15))';

    %-------------------------------------------------------------
    %
    conc_BB2_DPFtake5_Eadd5_SNR250 = pinv(BB2_E_add5) * (-change_I_BB2_SNR250 ./ (SD*BB2_DPF_take5))';

    conc_BB2_DPFtake10_Eadd5_SNR250 = pinv(BB2_E_add5) * (-change_I_BB2_SNR250 ./ (SD*BB2_DPF_take10))';

    conc_BB2_DPFtake15_Eadd5_SNR250 = pinv(BB2_E_add5) * (-change_I_BB2_SNR250 ./ (SD*BB2_DPF_take15))';

    %
    conc_BB2_DPFtake10_Eadd10_SNR250 = pinv(BB2_E_add10) * (-change_I_BB2_SNR250 ./ (SD*BB2_DPF_take10))';

    conc_BB2_DPFtake15_Eadd15_SNR250 = pinv(BB2_E_add15) * (-change_I_BB2_SNR250 ./ (SD*BB2_DPF_take15))';

    conc_BB2_DPFtake15_Eadd10_SNR250 = pinv(BB2_E_add10) * (-change_I_BB2_SNR250 ./ (SD*BB2_DPF_take15))';

    conc_BB2_DPFtake10_Eadd15_SNR250 = pinv(BB2_E_add15) * (-change_I_BB2_SNR250 ./ (SD*BB2_DPF_take10))';

    conc_BB2_DPFadd5_Etake15_SNR250 = pinv(BB2_E_take15) * (-change_I_BB2_SNR250 ./ (SD*BB2_DPF_add5))';

    conc_BB2_DPFadd5_Etake10_SNR250 = pinv(BB2_E_take10) * (-change_I_BB2_SNR250 ./ (SD*BB2_DPF_add5))';

    conc_BB2_DPFtake5_Eadd15_SNR250 = pinv(BB2_E_add15) * (-change_I_BB2_SNR250 ./ (SD*BB2_DPF_take5))';

    conc_BB2_DPFtake5_Eadd10_SNR250 = pinv(BB2_E_add10) * (-change_I_BB2_SNR250 ./ (SD*BB2_DPF_take5))';

    conc_BB2_DPFadd10_Etake15_SNR250 = pinv(BB2_E_take15) * (-change_I_BB2_SNR250 ./ (SD*BB2_DPF_add10))';

    conc_BB2_DPFadd15_Etake10_SNR250 = pinv(BB2_E_take10) * (-change_I_BB2_SNR250 ./ (SD*BB2_DPF_add15))';

    for t = 1:length(ac_conc_change)
        perc_error_BB2_DPFtake15_Eadd15_SNR250(t) = ((conc_BB2_DPFtake15_Eadd15_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB2_DPFtake10_Eadd10_SNR250(t) = ((conc_BB2_DPFtake10_Eadd10_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB2_DPFtake5_Eadd5_SNR250(t) = ((conc_BB2_DPFtake5_Eadd5_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB2_DPFadd15_Etake15_SNR250(t) = ((conc_BB2_DPFadd15_Etake15_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB2_DPFadd10_Etake10_SNR250(t) = ((conc_BB2_DPFadd10_Etake10_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB2_DPFadd5_Etake5_SNR250(t) = ((conc_BB2_DPFadd5_Etake5_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB2_DPFadd15_Eadd15_SNR250(t) = ((conc_BB2_DPFadd15_Eadd15_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB2_DPFadd10_Eadd10_SNR250(t) = ((conc_BB2_DPFadd10_Eadd10_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB2_DPFadd5_Eadd5_SNR250(t) = ((conc_BB2_DPFadd5_Eadd5_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB2_DPFtake15_Etake15_SNR250(t) = ((conc_BB2_DPFtake15_Etake15_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB2_DPFtake10_Etake10_SNR250(t) = ((conc_BB2_DPFtake10_Etake10_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB2_DPFtake5_Etake5_SNR250(t) = ((conc_BB2_DPFtake5_Etake5_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB2_DPFtake15_Eadd10_SNR250(t) = ((conc_BB2_DPFtake15_Eadd10_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB2_DPFtake15_Eadd5_SNR250(t) = ((conc_BB2_DPFtake15_Eadd5_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB2_DPFtake10_Eadd15_SNR250(t) = ((conc_BB2_DPFtake10_Eadd15_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB2_DPFtake10_Eadd5_SNR250(t) = ((conc_BB2_DPFtake10_Eadd5_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB2_DPFadd5_Etake15_SNR250(t) = ((conc_BB2_DPFadd5_Etake15_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB2_DPFadd5_Etake10_SNR250(t) = ((conc_BB2_DPFadd5_Etake10_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB2_DPFtake5_Eadd15_SNR250(t) = ((conc_BB2_DPFtake5_Eadd15_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB2_DPFtake5_Eadd10_SNR250(t) = ((conc_BB2_DPFtake5_Eadd10_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB2_DPFadd10_Etake15_SNR250(t) = ((conc_BB2_DPFadd10_Etake15_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB2_DPFadd10_Etake5_SNR250(t) = ((conc_BB2_DPFadd10_Etake5_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB2_DPFadd15_Etake10_SNR250(t) = ((conc_BB2_DPFadd15_Etake10_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB2_DPFadd15_Etake5_SNR250(t) = ((conc_BB2_DPFadd15_Etake5_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB2_5s_SNR250(t) = max(abs([perc_error_BB2_DPFtake5_Etake5_SNR250(t), perc_error_BB2_DPFadd5_Eadd5_SNR250(t), perc_error_BB2_DPFadd5_Etake5_SNR250(t), perc_error_BB2_DPFtake5_Eadd5_SNR250(t)]));
        perc_error_BB2_10s_SNR250(t) = max(abs([perc_error_BB2_DPFtake10_Etake10_SNR250(t), perc_error_BB2_DPFadd10_Eadd10_SNR250(t), perc_error_BB2_DPFadd10_Etake10_SNR250(t), perc_error_BB2_DPFtake10_Eadd10_SNR250(t)]));
        perc_error_BB2_15s_SNR250(t) = max(abs([perc_error_BB2_DPFtake15_Etake15_SNR250(t), perc_error_BB2_DPFadd15_Eadd15_SNR250(t), perc_error_BB2_DPFadd15_Etake15_SNR250(t), perc_error_BB2_DPFtake15_Eadd15_SNR250(t)]));
    end
    %%
    perc_accum_errors_DPFE_BB2SNR250 = [perc_diff_BB2; perc_error_BB2_5s_SNR250; perc_error_BB2_10s_SNR250; perc_error_BB2_15s_SNR250];

    perc_accum_errors_DPFE_BB2SNR250_saved{l} = perc_accum_errors_DPFE_BB2SNR250(:,:); %Save each iteration to cell array
...
for u = 1:4
    for j = 1:3
        for k = 1:10
            vector_error_BB2SNR250(k,j) = perc_accum_errors_DPFE_BB2SNR250_saved{1,k}(u,j);
        end
        ave_vector_error_BB2SNR250(u,j) = mean(vector_error_BB2SNR250(:,j));
        high_bar_vector_error_BB2SNR250(u,j) = max(vector_error_BB2SNR250(:,j));
        low_bar_vector_error_BB2SNR250(u,j) = min(vector_error_BB2SNR250(:,j));
    end
end
...
errorbar(percent_vector,ave_vector_error_BB2SNR250(:,1),low_bar_vector_error_BB2SNR250(:,1),high_bar_vector_error_BB2SNR250(:,1),'r*-','MarkerSize',20,'LineWidth',1.8)
hold on
errorbar(percent_vector,ave_vector_error_BB2SNR250(:,2),low_bar_vector_error_BB2SNR250(:,2),high_bar_vector_error_BB2SNR250(:,2),'bs-','MarkerSize',20,'LineWidth',1.5)
errorbar(percent_vector,ave_vector_error_BB2SNR250(:,3),low_bar_vector_error_BB2SNR250(:,3),high_bar_vector_error_BB2SNR250(:,3),'go-','MarkerSize',20,'LineWidth',1)
grid on
ax = gca;
ax.FontSize = 20;
xlim([-5 20]);
...
xlabel('Percentage change in both extinction coefficient and DPF values');
ylabel('Percentage error in chromophore concentration values');
title({'Comparison of percentage errors for increasing extinction coefficient', 'and DPF percentage changes for broadband system 2 (740-900nm), SNR = 250'});
...
for l = 1:20
    ...
    R1_BB3_SNR250 = awgn(R1_BB3,50,'measured');
    R2_BB3_SNR250 = awgn(R2_BB3,50,'measured');
    change_I_BB3_SNR250 = log(R2_BB3_SNR250) - log(R1_BB3_SNR250);
    % change_I_BB3_SNR250 = log(R2_BB3_SNR250) - log(R1_BB3);
    ...
    conc_BB3_SNR250 =  E_prime_invert_BB3 * (-change_I_BB3_SNR250 ./ (SD*ave_DPF_BB3))';
    ...
    for t = 1:length(ac_conc_change)
        ...
        perc_diff_BB3_SNR250(t) = ((conc_BB3_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_diff_BB3_SNR60(t) = ((conc_BB3_SNR60(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
    end

    perc_vector_SNR = [20;30;40;50;60;100];
    perc_diff_SNR_vector_BB3 = [perc_diff_BB3_SNR20;perc_diff_BB3_SNR30;perc_diff_BB3_SNR40;perc_diff_BB3_SNR250;perc_diff_BB3_SNR60;perc_diff_BB3];
...
%     saveas(gcf,'Comparison of percentage errors for increasing SNR of broadband system 3.png')
    ...
    % 
    % conc_BB3_assDPF_Eadd5_SNR250 = pinv(BB3_E_add5) * (-change_I_BB3_SNR250 ./ (SD*DPF_assumed))';
    % 
    % conc_BB3_assDPF_Eadd10_SNR250 = pinv(BB3_E_add10) * (-change_I_BB3_SNR250 ./ (SD*DPF_assumed))';
    % 
    % conc_BB3_assDPF_Eadd15_SNR250 = pinv(BB3_E_add15) * (-change_I_BB3_SNR250 ./ (SD*DPF_assumed))';
    % 
    % conc_BB3_assDPF_Eadd15_SNR30 = pinv(BB3_E_add15) * (-change_I_BB3_SNR30 ./ (SD*DPF_assumed))';

    %
    conc_BB3_DPFadd5_Eadd5_SNR250 = pinv(BB3_E_add5) * (-change_I_BB3_SNR250 ./ (SD*BB3_DPF_add5))';

    conc_BB3_DPFadd10_Eadd5_SNR250 = pinv(BB3_E_add5) * (-change_I_BB3_SNR250 ./ (SD*BB3_DPF_add10))';

    conc_BB3_DPFadd15_Eadd5_SNR250 = pinv(BB3_E_add5) * (-change_I_BB3_SNR250 ./ (SD*BB3_DPF_add15))';

    %
    conc_BB3_DPFadd10_Eadd10_SNR250 = pinv(BB3_E_add10) * (-change_I_BB3_SNR250 ./ (SD*BB3_DPF_add10))';

    conc_BB3_DPFadd15_Eadd15_SNR250 = pinv(BB3_E_add15) * (-change_I_BB3_SNR250 ./ (SD*BB3_DPF_add15))';

    %
    % %------------------------------------------------------------
    % conc_BB3_assDPF_Etake10 = pinv(BB3_E_take10) * (-change_I_BB3 ./ (SD*DPF_assumed))';
    % 
    % conc_BB3_assDPF_Etake5_SNR250 = pinv(BB3_E_take5) * (-change_I_BB3_SNR250 ./ (SD*DPF_assumed))';
    % 
    % conc_BB3_assDPF_Etake10_SNR250 = pinv(BB3_E_take10) * (-change_I_BB3_SNR250 ./ (SD*DPF_assumed))';
    % 
    % conc_BB3_assDPF_Etake15_SNR250 = pinv(BB3_E_take15) * (-change_I_BB3_SNR250 ./ (SD*DPF_assumed))';
    % 
    % conc_BB3_assDPF_Etake15_SNR30 = pinv(BB3_E_take15) * (-change_I_BB3_SNR30 ./ (SD*DPF_assumed))';

    %
    conc_BB3_DPFtake5_Etake5_SNR250 = pinv(BB3_E_take5) * (-change_I_BB3_SNR250 ./ (SD*BB3_DPF_take5))';

    conc_BB3_DPFtake10_Etake5_SNR250 = pinv(BB3_E_take5) * (-change_I_BB3_SNR250 ./ (SD*BB3_DPF_take10))';

    conc_BB3_DPFtake15_Etake5_SNR250 = pinv(BB3_E_take5) * (-change_I_BB3_SNR250 ./ (SD*BB3_DPF_take15))';

    %
    conc_BB3_DPFtake10_Etake10_SNR250 = pinv(BB3_E_take10) * (-change_I_BB3_SNR250 ./ (SD*BB3_DPF_take10))';

    conc_BB3_DPFtake15_Etake15_SNR250 = pinv(BB3_E_take15) * (-change_I_BB3_SNR250 ./ (SD*BB3_DPF_take15))';

    %
    %--------------------------------------------------------------------
    %
    conc_BB3_DPFadd5_Etake5_SNR250 = pinv(BB3_E_take5) * (-change_I_BB3_SNR250 ./ (SD*BB3_DPF_add5))';

    conc_BB3_DPFadd10_Etake5_SNR250 = pinv(BB3_E_take5) * (-change_I_BB3_SNR250 ./ (SD*BB3_DPF_add10))';

    conc_BB3_DPFadd15_Etake5_SNR250 = pinv(BB3_E_take5) * (-change_I_BB3_SNR250 ./ (SD*BB3_DPF_add15))';

    %
    conc_BB3_DPFadd10_Etake10_SNR250 = pinv(BB3_E_take10) * (-change_I_BB3_SNR250 ./ (SD*BB3_DPF_add10))';

    conc_BB3_DPFadd15_Etake15_SNR250 = pinv(BB3_E_take15) * (-change_I_BB3_SNR250 ./ (SD*BB3_DPF_add15))';

    %-------------------------------------------------------------
    %
    conc_BB3_DPFtake5_Eadd5_SNR250 = pinv(BB3_E_add5) * (-change_I_BB3_SNR250 ./ (SD*BB3_DPF_take5))';

    conc_BB3_DPFtake10_Eadd5_SNR250 = pinv(BB3_E_add5) * (-change_I_BB3_SNR250 ./ (SD*BB3_DPF_take10))';

    conc_BB3_DPFtake15_Eadd5_SNR250 = pinv(BB3_E_add5) * (-change_I_BB3_SNR250 ./ (SD*BB3_DPF_take15))';

    %
    conc_BB3_DPFtake10_Eadd10_SNR250 = pinv(BB3_E_add10) * (-change_I_BB3_SNR250 ./ (SD*BB3_DPF_take10))';

    conc_BB3_DPFtake15_Eadd15_SNR250 = pinv(BB3_E_add15) * (-change_I_BB3_SNR250 ./ (SD*BB3_DPF_take15))';

    conc_BB3_DPFtake15_Eadd10_SNR250 = pinv(BB3_E_add10) * (-change_I_BB3_SNR250 ./ (SD*BB3_DPF_take15))';

    conc_BB3_DPFtake10_Eadd15_SNR250 = pinv(BB3_E_add15) * (-change_I_BB3_SNR250 ./ (SD*BB3_DPF_take10))';

    conc_BB3_DPFadd5_Etake15_SNR250 = pinv(BB3_E_take15) * (-change_I_BB3_SNR250 ./ (SD*BB3_DPF_add5))';

    conc_BB3_DPFadd5_Etake10_SNR250 = pinv(BB3_E_take10) * (-change_I_BB3_SNR250 ./ (SD*BB3_DPF_add5))';

    conc_BB3_DPFtake5_Eadd15_SNR250 = pinv(BB3_E_add15) * (-change_I_BB3_SNR250 ./ (SD*BB3_DPF_take5))';

    conc_BB3_DPFtake5_Eadd10_SNR250 = pinv(BB3_E_add10) * (-change_I_BB3_SNR250 ./ (SD*BB3_DPF_take5))';

    conc_BB3_DPFadd10_Etake15_SNR250 = pinv(BB3_E_take15) * (-change_I_BB3_SNR250 ./ (SD*BB3_DPF_add10))';

    conc_BB3_DPFadd15_Etake10_SNR250 = pinv(BB3_E_take10) * (-change_I_BB3_SNR250 ./ (SD*BB3_DPF_add15))';

    for t = 1:length(ac_conc_change)
        perc_error_BB3_DPFtake15_Eadd15_SNR250(t) = ((conc_BB3_DPFtake15_Eadd15_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB3_DPFtake10_Eadd10_SNR250(t) = ((conc_BB3_DPFtake10_Eadd10_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB3_DPFtake5_Eadd5_SNR250(t) = ((conc_BB3_DPFtake5_Eadd5_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB3_DPFadd15_Etake15_SNR250(t) = ((conc_BB3_DPFadd15_Etake15_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB3_DPFadd10_Etake10_SNR250(t) = ((conc_BB3_DPFadd10_Etake10_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB3_DPFadd5_Etake5_SNR250(t) = ((conc_BB3_DPFadd5_Etake5_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB3_DPFadd15_Eadd15_SNR250(t) = ((conc_BB3_DPFadd15_Eadd15_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB3_DPFadd10_Eadd10_SNR250(t) = ((conc_BB3_DPFadd10_Eadd10_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB3_DPFadd5_Eadd5_SNR250(t) = ((conc_BB3_DPFadd5_Eadd5_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB3_DPFtake15_Etake15_SNR250(t) = ((conc_BB3_DPFtake15_Etake15_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB3_DPFtake10_Etake10_SNR250(t) = ((conc_BB3_DPFtake10_Etake10_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB3_DPFtake5_Etake5_SNR250(t) = ((conc_BB3_DPFtake5_Etake5_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB3_DPFtake15_Eadd10_SNR250(t) = ((conc_BB3_DPFtake15_Eadd10_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB3_DPFtake15_Eadd5_SNR250(t) = ((conc_BB3_DPFtake15_Eadd5_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB3_DPFtake10_Eadd15_SNR250(t) = ((conc_BB3_DPFtake10_Eadd15_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB3_DPFtake10_Eadd5_SNR250(t) = ((conc_BB3_DPFtake10_Eadd5_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB3_DPFadd5_Etake15_SNR250(t) = ((conc_BB3_DPFadd5_Etake15_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB3_DPFadd5_Etake10_SNR250(t) = ((conc_BB3_DPFadd5_Etake10_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB3_DPFtake5_Eadd15_SNR250(t) = ((conc_BB3_DPFtake5_Eadd15_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB3_DPFtake5_Eadd10_SNR250(t) = ((conc_BB3_DPFtake5_Eadd10_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB3_DPFadd10_Etake15_SNR250(t) = ((conc_BB3_DPFadd10_Etake15_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB3_DPFadd10_Etake5_SNR250(t) = ((conc_BB3_DPFadd10_Etake5_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB3_DPFadd15_Etake10_SNR250(t) = ((conc_BB3_DPFadd15_Etake10_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB3_DPFadd15_Etake5_SNR250(t) = ((conc_BB3_DPFadd15_Etake5_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB3_5s_SNR250(t) = max(abs([perc_error_BB3_DPFtake5_Etake5_SNR250(t), perc_error_BB3_DPFadd5_Eadd5_SNR250(t), perc_error_BB3_DPFadd5_Etake5_SNR250(t), perc_error_BB3_DPFtake5_Eadd5_SNR250(t)]));
        perc_error_BB3_10s_SNR250(t) = max(abs([perc_error_BB3_DPFtake10_Etake10_SNR250(t), perc_error_BB3_DPFadd10_Eadd10_SNR250(t), perc_error_BB3_DPFadd10_Etake10_SNR250(t), perc_error_BB3_DPFtake10_Eadd10_SNR250(t)]));
        perc_error_BB3_15s_SNR250(t) = max(abs([perc_error_BB3_DPFtake15_Etake15_SNR250(t), perc_error_BB3_DPFadd15_Eadd15_SNR250(t), perc_error_BB3_DPFadd15_Etake15_SNR250(t), perc_error_BB3_DPFtake15_Eadd15_SNR250(t)]));
    end
    %%
    perc_accum_errors_DPFE_BB3SNR250 = [perc_diff_BB3; perc_error_BB3_5s_SNR250; perc_error_BB3_10s_SNR250; perc_error_BB3_15s_SNR250];

    perc_accum_errors_DPFE_BB3SNR250_saved{l} = perc_accum_errors_DPFE_BB3SNR250(:,:); %Save each iteration to cell array
end
%%
...
for u = 1:4
    for j = 1:3
        for k = 1:10
            vector_error_BB3SNR250(k,j) = perc_accum_errors_DPFE_BB3SNR250_saved{1,k}(u,j);
        end
        ave_vector_error_BB3SNR250(u,j) = mean(vector_error_BB3SNR250(:,j));
        high_bar_vector_error_BB3SNR250(u,j) = max(vector_error_BB3SNR250(:,j));
        low_bar_vector_error_BB3SNR250(u,j) = min(vector_error_BB3SNR250(:,j));
    end
end
...
errorbar(percent_vector,ave_vector_error_BB3SNR250(:,1),low_bar_vector_error_BB3SNR250(:,1),high_bar_vector_error_BB3SNR250(:,1),'r*-','MarkerSize',20,'LineWidth',1.8)
hold on
errorbar(percent_vector,ave_vector_error_BB3SNR250(:,2),low_bar_vector_error_BB3SNR250(:,2),high_bar_vector_error_BB3SNR250(:,2),'bs-','MarkerSize',20,'LineWidth',1.5)
errorbar(percent_vector,ave_vector_error_BB3SNR250(:,3),low_bar_vector_error_BB3SNR250(:,3),high_bar_vector_error_BB3SNR250(:,3),'go-','MarkerSize',20,'LineWidth',1)
grid on
ax = gca;
ax.FontSize = 20;
xlim([-5 20]);
...
xlabel('Percentage change in both extinction coefficient and DPF values');
ylabel('Percentage error in chromophore concentration values');
title({'Comparison of percentage errors for increasing extinction coefficient', 'and DPF percentage changes for broadband system 3 (780-900nm), SNR = 250'});
...
for l = 1:20
    ...
    R1_BB4_SNR250 = awgn(R1_BB4,50,'measured');
    R2_BB4_SNR250 = awgn(R2_BB4,50,'measured');
    change_I_BB4_SNR250 = log(R2_BB4_SNR250) - log(R1_BB4_SNR250);
    % change_I_BB4_SNR250 = log(R2_BB4_SNR250) - log(R1_BB4);
    ...
    conc_BB4_SNR250 =  E_prime_invert_BB4 * (-change_I_BB4_SNR250 ./ (SD*ave_DPF_BB4))';
    ...
    for t = 1:length(ac_conc_change)
        ...
        perc_diff_BB4_SNR250(t) = ((conc_BB4_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_diff_BB4_SNR60(t) = ((conc_BB4_SNR60(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
    end

    perc_vector_SNR = [20;30;40;50;60;100];
    perc_diff_SNR_vector = [perc_diff_BB4_SNR20;perc_diff_BB4_SNR30;perc_diff_BB4_SNR40;perc_diff_BB4_SNR250;perc_diff_BB4_SNR60;perc_diff_BB4];
    perc_diff_SNR_vector = abs(perc_diff_SNR_vector);
    ...
    % 
    % conc_BB4_assDPF_Eadd5_SNR250 = pinv(BB4_E_add5) * (-change_I_BB4_SNR250 ./ (SD*DPF_assumed))';
    % 
    % conc_BB4_assDPF_Eadd10_SNR250 = pinv(BB4_E_add10) * (-change_I_BB4_SNR250 ./ (SD*DPF_assumed))';
    % 
    % conc_BB4_assDPF_Eadd15_SNR250 = pinv(BB4_E_add15) * (-change_I_BB4_SNR250 ./ (SD*DPF_assumed))';
    % 
    % conc_BB4_assDPF_Eadd15_SNR30 = pinv(BB4_E_add15) * (-change_I_BB4_SNR30 ./ (SD*DPF_assumed))';

    %
    conc_BB4_DPFadd5_Eadd5_SNR250 = pinv(BB4_E_add5) * (-change_I_BB4_SNR250 ./ (SD*BB4_DPF_add5))';

    conc_BB4_DPFadd10_Eadd5_SNR250 = pinv(BB4_E_add5) * (-change_I_BB4_SNR250 ./ (SD*BB4_DPF_add10))';

    conc_BB4_DPFadd15_Eadd5_SNR250 = pinv(BB4_E_add5) * (-change_I_BB4_SNR250 ./ (SD*BB4_DPF_add15))';

    %
    conc_BB4_DPFadd10_Eadd10_SNR250 = pinv(BB4_E_add10) * (-change_I_BB4_SNR250 ./ (SD*BB4_DPF_add10))';

    conc_BB4_DPFadd15_Eadd15_SNR250 = pinv(BB4_E_add15) * (-change_I_BB4_SNR250 ./ (SD*BB4_DPF_add15))';

    %
    %------------------------------------------------------------
    % conc_BB4_assDPF_Etake10 = pinv(BB4_E_take10) * (-change_I_BB4 ./ (SD*DPF_assumed))';
    % 
    % conc_BB4_assDPF_Etake5_SNR250 = pinv(BB4_E_take5) * (-change_I_BB4_SNR250 ./ (SD*DPF_assumed))';
    % 
    % conc_BB4_assDPF_Etake10_SNR250 = pinv(BB4_E_take10) * (-change_I_BB4_SNR250 ./ (SD*DPF_assumed))';
    % 
    % conc_BB4_assDPF_Etake15_SNR250 = pinv(BB4_E_take15) * (-change_I_BB4_SNR250 ./ (SD*DPF_assumed))';
    % 
    % conc_BB4_assDPF_Etake15_SNR30 = pinv(BB4_E_take15) * (-change_I_BB4_SNR30 ./ (SD*DPF_assumed))';

    %
    conc_BB4_DPFtake5_Etake5_SNR250 = pinv(BB4_E_take5) * (-change_I_BB4_SNR250 ./ (SD*BB4_DPF_take5))';

    conc_BB4_DPFtake10_Etake5_SNR250 = pinv(BB4_E_take5) * (-change_I_BB4_SNR250 ./ (SD*BB4_DPF_take10))';

    conc_BB4_DPFtake15_Etake5_SNR250 = pinv(BB4_E_take5) * (-change_I_BB4_SNR250 ./ (SD*BB4_DPF_take15))';

    %
    conc_BB4_DPFtake10_Etake10_SNR250 = pinv(BB4_E_take10) * (-change_I_BB4_SNR250 ./ (SD*BB4_DPF_take10))';

    conc_BB4_DPFtake15_Etake15_SNR250 = pinv(BB4_E_take15) * (-change_I_BB4_SNR250 ./ (SD*BB4_DPF_take15))';

    %
    %--------------------------------------------------------------------
    %
    conc_BB4_DPFadd5_Etake5_SNR250 = pinv(BB4_E_take5) * (-change_I_BB4_SNR250 ./ (SD*BB4_DPF_add5))';

    conc_BB4_DPFadd10_Etake5_SNR250 = pinv(BB4_E_take5) * (-change_I_BB4_SNR250 ./ (SD*BB4_DPF_add10))';

    conc_BB4_DPFadd15_Etake5_SNR250 = pinv(BB4_E_take5) * (-change_I_BB4_SNR250 ./ (SD*BB4_DPF_add15))';

    %
    conc_BB4_DPFadd10_Etake10_SNR250 = pinv(BB4_E_take10) * (-change_I_BB4_SNR250 ./ (SD*BB4_DPF_add10))';

    conc_BB4_DPFadd15_Etake15_SNR250 = pinv(BB4_E_take15) * (-change_I_BB4_SNR250 ./ (SD*BB4_DPF_add15))';

    %-------------------------------------------------------------
    %
    conc_BB4_DPFtake5_Eadd5_SNR250 = pinv(BB4_E_add5) * (-change_I_BB4_SNR250 ./ (SD*BB4_DPF_take5))';

    conc_BB4_DPFtake10_Eadd5_SNR250 = pinv(BB4_E_add5) * (-change_I_BB4_SNR250 ./ (SD*BB4_DPF_take10))';

    conc_BB4_DPFtake15_Eadd5_SNR250 = pinv(BB4_E_add5) * (-change_I_BB4_SNR250 ./ (SD*BB4_DPF_take15))';

    %
    conc_BB4_DPFtake10_Eadd10_SNR250 = pinv(BB4_E_add10) * (-change_I_BB4_SNR250 ./ (SD*BB4_DPF_take10))';

    conc_BB4_DPFtake15_Eadd15_SNR250 = pinv(BB4_E_add15) * (-change_I_BB4_SNR250 ./ (SD*BB4_DPF_take15))';

    conc_BB4_DPFtake15_Eadd10_SNR250 = pinv(BB4_E_add10) * (-change_I_BB4_SNR250 ./ (SD*BB4_DPF_take15))';

    conc_BB4_DPFtake10_Eadd15_SNR250 = pinv(BB4_E_add15) * (-change_I_BB4_SNR250 ./ (SD*BB4_DPF_take10))';

    conc_BB4_DPFadd5_Etake15_SNR250 = pinv(BB4_E_take15) * (-change_I_BB4_SNR250 ./ (SD*BB4_DPF_add5))';

    conc_BB4_DPFadd5_Etake10_SNR250 = pinv(BB4_E_take10) * (-change_I_BB4_SNR250 ./ (SD*BB4_DPF_add5))';

    conc_BB4_DPFtake5_Eadd15_SNR250 = pinv(BB4_E_add15) * (-change_I_BB4_SNR250 ./ (SD*BB4_DPF_take5))';

    conc_BB4_DPFtake5_Eadd10_SNR250 = pinv(BB4_E_add10) * (-change_I_BB4_SNR250 ./ (SD*BB4_DPF_take5))';

    conc_BB4_DPFadd10_Etake15_SNR250 = pinv(BB4_E_take15) * (-change_I_BB4_SNR250 ./ (SD*BB4_DPF_add10))';

    conc_BB4_DPFadd15_Etake10_SNR250 = pinv(BB4_E_take10) * (-change_I_BB4_SNR250 ./ (SD*BB4_DPF_add15))';

    for t = 1:length(ac_conc_change)
        perc_error_BB4_DPFtake15_Eadd15_SNR250(t) = ((conc_BB4_DPFtake15_Eadd15_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB4_DPFtake10_Eadd10_SNR250(t) = ((conc_BB4_DPFtake10_Eadd10_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB4_DPFtake5_Eadd5_SNR250(t) = ((conc_BB4_DPFtake5_Eadd5_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB4_DPFadd15_Etake15_SNR250(t) = ((conc_BB4_DPFadd15_Etake15_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB4_DPFadd10_Etake10_SNR250(t) = ((conc_BB4_DPFadd10_Etake10_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB4_DPFadd5_Etake5_SNR250(t) = ((conc_BB4_DPFadd5_Etake5_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB4_DPFadd15_Eadd15_SNR250(t) = ((conc_BB4_DPFadd15_Eadd15_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB4_DPFadd10_Eadd10_SNR250(t) = ((conc_BB4_DPFadd10_Eadd10_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB4_DPFadd5_Eadd5_SNR250(t) = ((conc_BB4_DPFadd5_Eadd5_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB4_DPFtake15_Etake15_SNR250(t) = ((conc_BB4_DPFtake15_Etake15_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB4_DPFtake10_Etake10_SNR250(t) = ((conc_BB4_DPFtake10_Etake10_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB4_DPFtake5_Etake5_SNR250(t) = ((conc_BB4_DPFtake5_Etake5_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB4_DPFtake15_Eadd10_SNR250(t) = ((conc_BB4_DPFtake15_Eadd10_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB4_DPFtake15_Eadd5_SNR250(t) = ((conc_BB4_DPFtake15_Eadd5_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB4_DPFtake10_Eadd15_SNR250(t) = ((conc_BB4_DPFtake10_Eadd15_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB4_DPFtake10_Eadd5_SNR250(t) = ((conc_BB4_DPFtake10_Eadd5_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB4_DPFadd5_Etake15_SNR250(t) = ((conc_BB4_DPFadd5_Etake15_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB4_DPFadd5_Etake10_SNR250(t) = ((conc_BB4_DPFadd5_Etake10_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB4_DPFtake5_Eadd15_SNR250(t) = ((conc_BB4_DPFtake5_Eadd15_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB4_DPFtake5_Eadd10_SNR250(t) = ((conc_BB4_DPFtake5_Eadd10_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB4_DPFadd10_Etake15_SNR250(t) = ((conc_BB4_DPFadd10_Etake15_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB4_DPFadd10_Etake5_SNR250(t) = ((conc_BB4_DPFadd10_Etake5_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB4_DPFadd15_Etake10_SNR250(t) = ((conc_BB4_DPFadd15_Etake10_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
        perc_error_BB4_DPFadd15_Etake5_SNR250(t) = ((conc_BB4_DPFadd15_Etake5_SNR250(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

        perc_error_BB4_5s_SNR250(t) = max(abs([perc_error_BB4_DPFtake5_Etake5_SNR250(t), perc_error_BB4_DPFadd5_Eadd5_SNR250(t), perc_error_BB4_DPFadd5_Etake5_SNR250(t), perc_error_BB4_DPFtake5_Eadd5_SNR250(t)]));
        perc_error_BB4_10s_SNR250(t) = max(abs([perc_error_BB4_DPFtake10_Etake10_SNR250(t), perc_error_BB4_DPFadd10_Eadd10_SNR250(t), perc_error_BB4_DPFadd10_Etake10_SNR250(t), perc_error_BB4_DPFtake10_Eadd10_SNR250(t)]));
        perc_error_BB4_15s_SNR250(t) = max(abs([perc_error_BB4_DPFtake15_Etake15_SNR250(t), perc_error_BB4_DPFadd15_Eadd15_SNR250(t), perc_error_BB4_DPFadd15_Etake15_SNR250(t), perc_error_BB4_DPFtake15_Eadd15_SNR250(t)]));
    end
    %%
    perc_accum_errors_DPFE_BB4SNR250 = [perc_diff_BB4; perc_error_BB4_5s_SNR250; perc_error_BB4_10s_SNR250; perc_error_BB4_15s_SNR250];

    perc_accum_errors_DPFE_BB4SNR250_saved{l} = perc_accum_errors_DPFE_BB4SNR250(:,:); %Save each iteration to cell array
end
%%
...
for u = 1:4
    for j = 1:3
        for k = 1:10
            vector_error_BB4SNR250(k,j) = perc_accum_errors_DPFE_BB4SNR250_saved{1,k}(u,j);
        end
        ave_vector_error_BB4SNR250(u,j) = mean(vector_error_BB4SNR250(:,j));
        high_bar_vector_error_BB4SNR250(u,j) = max(vector_error_BB4SNR250(:,j));
        low_bar_vector_error_BB4SNR250(u,j) = min(vector_error_BB4SNR250(:,j));
    end
end
...
FigH = figure('Position', get(0, 'Screensize'));
F = getframe(FigH);
imwrite(F.cdata, 'Comparison of percentage errors for increasing extinction coefficient and DPF percentage changes for broadband system 4 SNR 50.png', 'png')
errorbar(percent_vector,ave_vector_error_BB4SNR250(:,1),low_bar_vector_error_BB4SNR250(:,1),high_bar_vector_error_BB4SNR250(:,1),'r*-','MarkerSize',20,'LineWidth',1.8)
hold on
errorbar(percent_vector,ave_vector_error_BB4SNR250(:,2),low_bar_vector_error_BB4SNR250(:,2),high_bar_vector_error_BB4SNR250(:,2),'bs-','MarkerSize',20,'LineWidth',1.5)
errorbar(percent_vector,ave_vector_error_BB4SNR250(:,3),low_bar_vector_error_BB4SNR250(:,3),high_bar_vector_error_BB4SNR250(:,3),'go-','MarkerSize',20,'LineWidth',1)
grid on
ax = gca;
ax.FontSize = 20;
xlim([-5 20]);
...
xlabel('Percentage change in both extinction coefficient and DPF values');
ylabel('Percentage error in chromophore concentration values');
title({'Comparison of percentage errors for increasing extinction coefficient', 'and DPF percentage changes for broadband system 4 (720-900nm), SNR = 250'});
saveas(gcf,'Comparison of percentage errors for increasing extinction coefficient percentage changes for broadband system 4 SNR 50.png')
