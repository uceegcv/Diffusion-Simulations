...
for nwavs = 5:200
    ...
    %     end
        ...
        concs2_saved{pert_number} = concs2;
...
%                 saveas(gcf,'Comparison of percentage errors for increasing DPF percentage changes for 5-wavelength LED system.png')
                ...
                %
                conc_DPFadd5_Eadd5_LED = pinv(LED_E_add5) * (-change_I_LED ./ (SD*LED_DPF_add5))';

                conc_DPFadd10_Eadd5_LED = pinv(LED_E_add5) * (-change_I_LED ./ (SD*LED_DPF_add10))';

                conc_DPFadd15_Eadd5_LED = pinv(LED_E_add5) * (-change_I_LED ./ (SD*LED_DPF_add15))';

                %
                conc_DPFadd10_Eadd10_LED = pinv(LED_E_add10) * (-change_I_LED ./ (SD*LED_DPF_add10))';

                conc_DPFadd15_Eadd15_LED = pinv(LED_E_add15) * (-change_I_LED ./ (SD*LED_DPF_add15))';

                %
                %------------------------------------------------------------
                %
                conc_DPFtake5_Etake5_LED = pinv(LED_E_take5) * (-change_I_LED ./ (SD*LED_DPF_take5))';

                conc_DPFtake10_Etake5_LED = pinv(LED_E_take5) * (-change_I_LED ./ (SD*LED_DPF_take10))';

                conc_DPFtake15_Etake5_LED = pinv(LED_E_take5) * (-change_I_LED ./ (SD*LED_DPF_take15))';

                %
                conc_DPFtake10_Etake10_LED = pinv(LED_E_take10) * (-change_I_LED ./ (SD*LED_DPF_take10))';

                conc_DPFtake15_Etake15_LED = pinv(LED_E_take15) * (-change_I_LED ./ (SD*LED_DPF_take15))';

                %
                %--------------------------------------------------------------------
                %
                conc_DPFadd5_Etake5_LED = pinv(LED_E_take5) * (-change_I_LED ./ (SD*LED_DPF_add5))';

                conc_DPFadd10_Etake5_LED = pinv(LED_E_take5) * (-change_I_LED ./ (SD*LED_DPF_add10))';

                conc_DPFadd15_Etake5_LED = pinv(LED_E_take5) * (-change_I_LED ./ (SD*LED_DPF_add15))';

                %
                conc_DPFadd10_Etake10_LED = pinv(LED_E_take10) * (-change_I_LED ./ (SD*LED_DPF_add10))';

                conc_DPFadd15_Etake15_LED = pinv(LED_E_take15) * (-change_I_LED ./ (SD*LED_DPF_add15))';

                %-------------------------------------------------------------
                %
                conc_DPFtake5_Eadd5_LED = pinv(LED_E_add5) * (-change_I_LED ./ (SD*LED_DPF_take5))';

                conc_DPFtake10_Eadd5_LED = pinv(LED_E_add5) * (-change_I_LED ./ (SD*LED_DPF_take10))';

                conc_DPFtake15_Eadd5_LED = pinv(LED_E_add5) * (-change_I_LED ./ (SD*LED_DPF_take15))';

                %
                conc_DPFtake10_Eadd10_LED = pinv(LED_E_add10) * (-change_I_LED ./ (SD*LED_DPF_take10))';

                conc_DPFtake15_Eadd15_LED = pinv(LED_E_add15) * (-change_I_LED ./ (SD*LED_DPF_take15))';

                conc_DPFtake15_Eadd10_LED = pinv(LED_E_add10) * (-change_I_LED ./ (SD*LED_DPF_take15))';

                conc_DPFtake10_Eadd15_LED = pinv(LED_E_add15) * (-change_I_LED ./ (SD*LED_DPF_take10))';

                conc_DPFadd5_Etake15_LED = pinv(LED_E_take15) * (-change_I_LED ./ (SD*LED_DPF_add5))';

                conc_DPFadd5_Etake10_LED = pinv(LED_E_take10) * (-change_I_LED ./ (SD*LED_DPF_add5))';

                conc_DPFtake5_Eadd15_LED = pinv(LED_E_add15) * (-change_I_LED ./ (SD*LED_DPF_take5))';

                conc_DPFtake5_Eadd10_LED = pinv(LED_E_add10) * (-change_I_LED ./ (SD*LED_DPF_take5))';

                conc_DPFadd10_Etake15_LED = pinv(LED_E_take15) * (-change_I_LED ./ (SD*LED_DPF_add10))';

                conc_DPFadd15_Etake10_LED = pinv(LED_E_take10) * (-change_I_LED ./ (SD*LED_DPF_add15))';

                for t = 1:length(ac_conc_change)
                    perc_error_LED_DPFtake15_Eadd15(t) = ((conc_DPFtake15_Eadd15_LED(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
                    perc_error_LED_DPFtake10_Eadd10(t) = ((conc_DPFtake10_Eadd10_LED(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
                    perc_error_LED_DPFtake5_Eadd5(t) = ((conc_DPFtake5_Eadd5_LED(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

                    perc_error_LED_DPFadd15_Etake15(t) = ((conc_DPFadd15_Etake15_LED(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
                    perc_error_LED_DPFadd10_Etake10(t) = ((conc_DPFadd10_Etake10_LED(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
                    perc_error_LED_DPFadd5_Etake5(t) = ((conc_DPFadd5_Etake5_LED(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

                    perc_error_LED_DPFadd15_Eadd15(t) = ((conc_DPFadd15_Eadd15_LED(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
                    perc_error_LED_DPFadd10_Eadd10(t) = ((conc_DPFadd10_Eadd10_LED(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
                    perc_error_LED_DPFadd5_Eadd5(t) = ((conc_DPFadd5_Eadd5_LED(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

                    perc_error_LED_DPFtake15_Etake15(t) = ((conc_DPFtake15_Etake15_LED(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
                    perc_error_LED_DPFtake10_Etake10(t) = ((conc_DPFtake10_Etake10_LED(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
                    perc_error_LED_DPFtake5_Etake5(t) = ((conc_DPFtake5_Etake5_LED(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

                    perc_error_LED_DPFtake15_Eadd10(t) = ((conc_DPFtake15_Eadd10_LED(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
                    perc_error_LED_DPFtake15_Eadd5(t) = ((conc_DPFtake15_Eadd5_LED(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

                    perc_error_LED_DPFtake10_Eadd15(t) = ((conc_DPFtake10_Eadd15_LED(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
                    perc_error_LED_DPFtake10_Eadd5(t) = ((conc_DPFtake10_Eadd5_LED(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

                    perc_error_LED_DPFadd5_Etake15(t) = ((conc_DPFadd5_Etake15_LED(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
                    perc_error_LED_DPFadd5_Etake10(t) = ((conc_DPFadd5_Etake10_LED(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

                    perc_error_LED_DPFtake5_Eadd15(t) = ((conc_DPFtake5_Eadd15_LED(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
                    perc_error_LED_DPFtake5_Eadd10(t) = ((conc_DPFtake5_Eadd10_LED(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

                    perc_error_LED_DPFadd10_Etake15(t) = ((conc_DPFadd10_Etake15_LED(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
                    perc_error_LED_DPFadd10_Etake5(t) = ((conc_DPFadd10_Etake5_LED(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

                    perc_error_LED_DPFadd15_Etake10(t) = ((conc_DPFadd15_Etake10_LED(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;
                    perc_error_LED_DPFadd15_Etake5(t) = ((conc_DPFadd15_Etake5_LED(t) - ac_conc_change(t))/ac_conc_change(t)) * 100;

                    perc_error_LED_5s(t) = max(abs([perc_error_LED_DPFtake5_Etake5(t), perc_error_LED_DPFadd5_Eadd5(t), perc_error_LED_DPFadd5_Etake5(t), perc_error_LED_DPFtake5_Eadd5(t)]));
                    perc_error_LED_10s(t) = max(abs([perc_error_LED_DPFtake10_Etake10(t), perc_error_LED_DPFadd10_Eadd10(t), perc_error_LED_DPFadd10_Etake10(t), perc_error_LED_DPFtake10_Eadd10(t)]));
                    perc_error_LED_15s(t) = max(abs([perc_error_LED_DPFtake15_Etake15(t), perc_error_LED_DPFadd15_Eadd15(t), perc_error_LED_DPFadd15_Etake15(t), perc_error_LED_DPFtake15_Eadd15(t)]));
                end
                %%
                perc_accum_errors_DPFE_LED = [perc_diff_LED; perc_error_LED_5s; perc_error_LED_10s; perc_error_LED_15s];
                perc_accum_errors_DPFE_LED = abs(perc_accum_errors_DPFE_LED);

                perc_accum_errors_DPFE_LED_saved{l} = perc_accum_errors_DPFE_LED(:,:); %Save each iteration to cell array
...
%                 saveas(gcf,'Comparison of percentage errors for increasing extinction coefficient percentage changes for 5-wavelength LED system.png')
        ...
        for u = 1:4
            for j = 1:3
                for k = 1:10
                    vector_error_LEDnoSNR(k,j) = perc_accum_errors_DPFE_LED_saved{1,k}(u,j);
                    %perc_error_E_vector_LED_saved
                end
                ave_vector_error_LEDnoSNR(u,j) = mean(vector_error_LEDnoSNR(:,j));
                high_bar_vector_error_LEDnoSNR(u,j) = max(vector_error_LEDnoSNR(:,j));
                low_bar_vector_error_LEDnoSNR(u,j) = min(vector_error_LEDnoSNR(:,j));
                stand_dev_LEDnoSNR(u,j) = std(vector_error_LEDnoSNR(:,j));
            end
        end

        pert_ave_error_LED_noSNR{pert_number} = ave_vector_error_LEDnoSNR(:,:);
        pert_high_bar_error_LED_noSNR{pert_number} = high_bar_vector_error_LEDnoSNR;
        pert_low_bar_error_LED_noSNR{pert_number} = low_bar_vector_error_LEDnoSNR;
        pert_stand_dev_LED_noSNR{pert_number} = stand_dev_LEDnoSNR;
    ...
    num_wavs = length(x);
    save(['ave_error_',num2str(num_wavs),'_wavelengths_std_SNR50'],'ave_pert_error_LEDSNR50','final_std_val_LEDSNR50','concs2_saved')
    ...
    for u = 1:4
        for j = 1:3
            for k = 1:pert_number
                total_pert_error_LEDnoSNR(k,j) = pert_ave_error_LED_noSNR{1,k}(u,j);
                high_bar_vector_error_LEDnoSNR(k,j) = pert_high_bar_error_LED_noSNR{1,k}(u,j);
                low_bar_vector_error_LEDnoSNR(k,j) = pert_low_bar_error_LED_noSNR{1,k}(u,j);
                standard_dev_LEDnoSNR(k,j) = pert_stand_dev_LED_noSNR{1,k}(u,j);
            end
            val_to_ave_error_noSNR = total_pert_error_LEDnoSNR(:,j);
            high_to_ave_error_noSNR = high_bar_vector_error_LEDnoSNR(:,j);
            low_to_ave_error_noSNR = low_bar_vector_error_LEDnoSNR(:,j);
            stdtoave_noSNR = standard_dev_LEDnoSNR(:,j);
            ave_pert_error_LEDnoSNR(u,j) = mean(val_to_ave_error_noSNR(val_to_ave_error_noSNR<Inf));
            high_bar_pert_error_LEDnoSNR(u,j) = mean(high_to_ave_error_noSNR(high_to_ave_error_noSNR<Inf));
            low_bar_pert_error_LEDnoSNR(u,j) = mean(low_to_ave_error_noSNR(low_to_ave_error_noSNR<Inf));
            final_std_val_LEDnoSNR(u,j) = mean(stdtoave_noSNR(stdtoave_noSNR<Inf));
        end
    end

    num_wavs = length(x);
    save(['ave_error_',num2str(num_wavs),'_wavelengths_std_noSNR'],'ave_pert_error_LEDnoSNR','final_std_val_LEDnoSNR','concs2_saved')
