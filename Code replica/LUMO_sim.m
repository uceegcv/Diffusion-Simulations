...
xlabel('Percentage change in both extinction coefficient and DPF values');
ylabel('Percentage error in chromophore concentration values');
title({'Comparison of percentage errors for increasing extinction coefficient', 'and DPF percentage changes for LUMO, SNR = 50'});
saveas(gcf,'Comparison of percentage errors for increasing extinction coefficient percentage changes for LUMO SNR 50.png')
